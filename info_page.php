...
<h2>Vos incormations personnelles :</h2>
...
<ul>
          <li>Nom: <span><?= $_SESSION['nom']; ?></span></li>
           ...
           <li>date de naissance: <span><?= $_SESSION['a_naissance']; ?></span></li>
           <li>adresse: <span><?= $_SESSION['adresse']; ?></span></li>
           <li>ville: <span><?= $_SESSION['ville']; ?></span></li>
           <li>code postal: <span><?= $_SESSION['code']; ?></span></li>
           <li>login: <span><?= $_SESSION['login']; ?></span></li>
</ul>


<a href="modif.php" class="btn btn-danger">Modifier vos informations</a>
